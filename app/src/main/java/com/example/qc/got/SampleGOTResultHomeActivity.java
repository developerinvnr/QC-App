...
public class SampleGOTResultHomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sample_g_o_t_result_home);
    ...
    private void init() {
        btn_samplecollectionscan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                IntentIntegrator integrator = new IntentIntegrator(SampleGOTResultHomeActivity.this);
        ...
        btn_samplecollectionmanual.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                final Dialog dialog = new Dialog(SampleGOTResultHomeActivity.this);
                ...
                search_Btn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        dialog.dismiss();
                        /*Intent intent = new Intent(SampleGOTResultHomeActivity.this, GOTResultStepsActivity.class);
        ...
        back_nav.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(SampleGOTResultHomeActivity.this, MainActivity.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
                startActivity(intent);
                finish();
            }
    ...
    private void getSampleInfo(String contents) {
        ...
        new SendVolleyCall().executeProgram(SampleGOTResultHomeActivity.this, AppConfig.SAMPLEINFO_GOT_PROGRAM, params, new volleyCallback() {
            @Override
            public void onSuccess(String response) {
                pDialog.dismiss();
                JsonParser.getInstance().sampleGOTInfoParser(response);
                SampleGOTInfo sampleInfo = (SampleGOTInfo) SharedPreferences.getInstance().getObject(SharedPreferences.KEY_SAMPLEINFO_OBJ, SampleGOTInfo.class);
