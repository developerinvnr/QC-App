...
public class BTSSeedlingDispatchHomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_b_t_s_seedling_dispatch_home);
    ...
    private void init() {
        btn_samplescan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                IntentIntegrator integrator = new IntentIntegrator(BTSSeedlingDispatchHomeActivity.this);
        ...
        btn_samplemanual.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                final Dialog dialog = new Dialog(BTSSeedlingDispatchHomeActivity.this);
        ...
        back_nav.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(BTSSeedlingDispatchHomeActivity.this, MainActivity.class);
    ...
    private void getSampleInfo(String sampleno) {
        ...
        new SendVolleyCall().executeProgram(BTSSeedlingDispatchHomeActivity.this, AppConfig.SAMPLEINFO_BTS_DISPLIST, params, new volleyCallback() {
            @Override
            public void onSuccess(String response) {
                ...
                if (sampleInfo.getMassage().equalsIgnoreCase("Success")){
                    Intent intent = new Intent(BTSSeedlingDispatchHomeActivity.this, BTSSeedlingDispatchFormActivity.class);
                    startActivity(intent);
                }else {
